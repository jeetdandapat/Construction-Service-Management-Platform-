...
export default function ServicesPage() {
  return (
    <section className=" reveal py-20 px-6 bg-gray-50">
      <div className=" reveal max-w-7xl mx-auto text-center mb-16">
        <h2 className="text-4xl md:text-5xl font-extrabold text-gray-800">
          Our Services
        </h2>
        <p className=  " reveal text-gray-600 mt-4 max-w-2xl mx-auto">
      ...
      <div className="reveal max-w-6xl mx-auto grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
        {services.map((service, index) => (
          ...
          >
            <div className=" reveal mb-5">{service.icon}</div>
